...
if nargin==0     % nargin is the number of function input arguments
    scatplotdemo
    return
end
...
switch po
    case {1,2}
        ...
        out.hs = hs;
        colorbarrr = colorbar;
        set(colorbarrr, 'ytick',[0 0.3 0.6 1], 'yticklabel', {'1', '5', '15', '>25'},...
            'location', 'south','position', [0.45 0.23 0.4 0.04],'color', 'k','fontname','Times New Roman', 'fontsize', 16);
        set(get(colorbarrr, 'title'), 'string', 'Number of observations', 'fontname','Times New Roman', 'fontsize', 18);
...
map = colormap(jet); % colormap …Ë÷√Œ™jet
